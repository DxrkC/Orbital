...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.misc.custom_player_model, false, crypt_str("Misc.custom_player_model"));
	...
	setup_item(&g_cfg.menu.menu_theme, Color(135, 158, 212), crypt_str("Menu.menu_color"));
	setup_item(&g_cfg.menu.watermark, false, crypt_str("Menu.watermark"));
	setup_item(&g_cfg.menu.watermark_color, Color(135, 158, 212), crypt_str("Menu.watermark_color"));
	setup_item(&g_cfg.menu.watermark_color_background, Color(86, 92, 105), crypt_str("Menu.watermark_color_background"));
...
{
	std::string file = crypt_str("C:\\Orbital\\Configs\\") + config;
	json allJson;
...
{
	std::string file = crypt_str("C:\\Orbital\\Configs\\");
